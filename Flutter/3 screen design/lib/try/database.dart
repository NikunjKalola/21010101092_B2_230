...
class MyDatabase{
  Future<Database> initDatabase() async {
    ...
    String databasePath = join(appDocDir.path, 'logininfo.db');
  ...
  Future<void> copyPasteAssetFileToRoot() async {
    ...
    String path = join(documentsDirectory.path, "logininfo.db");

    if (FileSystemEntity.typeSync(path) == FileSystemEntityType.notFound) {
      ByteData data =
      await rootBundle.load(join('assets/database', 'logininfo.db'));
      List<int> bytes =
